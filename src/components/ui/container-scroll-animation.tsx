...
export const ContainerScroll = ({
  ...
  return (
    <div
      className="relative flex h-auto justify-center px-2 md:h-[60rem] lg:h-[70rem] md:px-20 md:pt-20"
      ref={containerRef}
    >
      <div
...
export const Card = ({
  ...
  return (
    <motion.div
      ...
      className="mx-auto mt-[-16rem] md:-mt-12 lg:-mt-20   w-full max-w-5xl rounded-[30px]"
    >
